...
void *binc_buffer_native(BincBuffer *buffer);
void *binc_runtime_device(BincRuntime *rt);
void *binc_runtime_queue(BincRuntime *rt);
void *binc_runtime_library(BincRuntime *rt);
